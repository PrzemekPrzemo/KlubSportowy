...
use App\Sports\Volleyball\Models\VolleyballTransferModel;
...
class TransfersController extends BaseController
{
    ...
    public function index(): void
    {
        ...
        $pagination = (new VolleyballTransferModel())->listForClub($page, 20);
        $this->render('volleyball/transfers/index', ['title' => 'Transfery', 'pagination' => $pagination]);
    }

    public function create(): void
    {
        $members = (new MemberModel())->search('', 'aktywny', null, 1, 500)['data'] ?? [];
        $this->render('volleyball/transfers/form', ['title' => 'Nowy transfer', 'transfer' => null, 'members' => $members]);
    }
    ...
    public function store(): void
    {
        ...
        if ($data['member_id'] <= 0 || $data['transfer_date'] === '') {
            ...
            $this->redirect('volleyball/transfers/create');
        }
        (new VolleyballTransferModel())->insert($data);
        Session::flash('success', 'Transfer zarejestrowany.');
        $this->redirect('volleyball/transfers');
    }

    public function delete(string $id): void
    {
        Csrf::verify();
        (new VolleyballTransferModel())->delete((int)$id);
