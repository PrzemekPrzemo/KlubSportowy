...
<div class="mb-3 text-end">
    <a href="<?= url('volleyball/transfers/create') ?>" class="btn btn-success"><i class="bi bi-plus"></i> Nowy transfer</a>
</div>
<div class="card">
    <table class="table table-hover mb-0">
        ...
        ?>
            <tr>
                ...
                <td class="text-end">
                    <form method="POST" action="<?= url('volleyball/transfers/' . (int)$t['id'] . '/delete') ?>" onsubmit="return confirm('Usunąć?')" class="d-inline">
