...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="mb-0"><i class="bi bi-snow text-primary me-2"></i>Mecze — Curling</h4>
    ...
    <div class="table-responsive">
        <table class="table table-hover mb-0">
            <thead class="table-light">
                <tr><th>Data</th><th>Gospodarze</th><th>Wynik</th><th>Goście</th><th>Endów</th><th>Status</th><th></th></tr>
            </thead>
            <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="text-center"><?= (int)$m['ends_planned'] ?></td>
                    <td><span class="badge bg-<?= $si['class'] ?>"><?= View::e($si['label']) ?></span></td>
                    <td class="d-flex gap-1">
                        <a href="<?= url('curling/matches/' . (int)$m['id'] . '/stats') ?>" class="btn btn-sm btn-outline-primary" title="Endy">
                            <i class="bi bi-grid-3x3-gap"></i>
                        </a>
                        <form method="POST" action="<?= url('curling/matches/' . (int)$m['id'] . '/delete') ?>" onsubmit="return confirm('Usunąć?')">
                            <?= csrf_field() ?>
...
<div class="modal fade" id="matchModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="POST" action="<?= url('curling/matches/store') ?>">
                <?= csrf_field() ?>
                ...
                <div class="modal-body">
                    <div class="row g-2">
                        ...
                        <div class="col-6"><label class="form-label">Goście</label>
                        ...
                        <div class="col-6"><label class="form-label">Lodowisko</label>
                            <input type="text" name="location" class="form-control">
                        </div>
                        <div class="col-4"><label class="form-label">Endów</label>
                            <input type="number" name="ends_planned" class="form-control" min="4" max="10" value="8">
                        </div>
                        <div class="col-4"><label class="form-label">Hammer w endzie 1</label>
                            <select name="hammer_start" class="form-select">
                                <option value="away" selected>Goście</option>
