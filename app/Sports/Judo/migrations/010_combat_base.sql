...
CREATE TABLE IF NOT EXISTS `judo_belts` (
    ...
    UNIQUE KEY `uniq_club_code` (`club_id`, `code`),
    KEY `idx_judo_belts_club` (`club_id`),
    FOREIGN KEY (`club_id`) REFERENCES `clubs`(`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `judo_member_grades` (
    `id`           INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    `club_id`      INT UNSIGNED NOT NULL,
    ...
    KEY `idx_judo_grades_member` (`member_id`),
    KEY `idx_judo_grades_club`   (`club_id`),
    KEY `idx_judo_grades_belt`   (`belt_id`),
    FOREIGN KEY (`club_id`)   REFERENCES `clubs`(`id`)              ON DELETE CASCADE,
    FOREIGN KEY (`member_id`) REFERENCES `members`(`id`)            ON DELETE CASCADE,
    FOREIGN KEY (`belt_id`)   REFERENCES `judo_belts`(`id`)    ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
