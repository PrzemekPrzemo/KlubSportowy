-- Taekwondo combat-sports base migration
-- Wspolne tabele dla sportow walki: kategorie wagowe, stopnie, historia stopni czlonkow.
SET foreign_key_checks = 0;

CREATE TABLE IF NOT EXISTS `taekwondo_weight_classes` (
    ...
    KEY `idx_taekwondo_wc_club` (`club_id`),
...
CREATE TABLE IF NOT EXISTS `taekwondo_belts` (
    ...
    UNIQUE KEY `uniq_club_code` (`club_id`, `code`),
    KEY `idx_taekwondo_belts_club` (`club_id`),
    FOREIGN KEY (`club_id`) REFERENCES `clubs`(`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `taekwondo_member_grades` (
    `id`           INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    `club_id`      INT UNSIGNED NOT NULL,
    ...
    KEY `idx_taekwondo_grades_member` (`member_id`),
    KEY `idx_taekwondo_grades_club`   (`club_id`),
    KEY `idx_taekwondo_grades_belt`   (`belt_id`),
    FOREIGN KEY (`club_id`)   REFERENCES `clubs`(`id`)              ON DELETE CASCADE,
    FOREIGN KEY (`member_id`) REFERENCES `members`(`id`)            ON DELETE CASCADE,
    FOREIGN KEY (`belt_id`)   REFERENCES `taekwondo_belts`(`id`)    ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
