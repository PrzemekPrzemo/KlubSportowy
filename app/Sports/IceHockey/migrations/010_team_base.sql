...
CREATE TABLE IF NOT EXISTS `ice_hockey_team_members` (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    ...
    FOREIGN KEY (team_id) REFERENCES `ice_hockey_teams`(id) ON DELETE CASCADE,
    FOREIGN KEY (member_id) REFERENCES members(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `ice_hockey_matches` (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    club_id INT UNSIGNED NOT NULL,
    ...
    periods JSON NULL COMMENT 'np. [[1,0],[2,1],[1,2]] tercje',
    ...
    FOREIGN KEY (club_id) REFERENCES clubs(id) ON DELETE CASCADE,
    FOREIGN KEY (home_team_id) REFERENCES `ice_hockey_teams`(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `ice_hockey_match_stats` (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    ...
    extra JSON NULL COMMENT 'sport-specific stats (shots, saves, plus_minus, penalty_minutes, etc.)',
    UNIQUE KEY uniq_match_member (match_id, member_id),
    FOREIGN KEY (match_id) REFERENCES `ice_hockey_matches`(id) ON DELETE CASCADE,
    FOREIGN KEY (member_id) REFERENCES members(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
