...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="mb-0"><i class="bi bi-trophy text-primary me-2"></i>Mecze — Hokej na trawie</h4>
    ...
    <div class="table-responsive">
        <table class="table table-hover mb-0">
            <thead class="table-light">
                <tr><th>Data</th><th>Gospodarze</th><th>Wynik</th><th>Goście</th><th>Status</th><th>Miejsce</th><th></th></tr>
            </thead>
            <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <form method="POST" action="<?= url('fieldhockey/matches/' . (int)$m['id'] . '/delete') ?>" onsubmit="return confirm('Usunąć?')">
                            <?= csrf_field() ?>
...
<div class="modal fade" id="matchModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="POST" action="<?= url('fieldhockey/matches/store') ?>">
                <?= csrf_field() ?>
                ...
                <div class="modal-body">
                    <div class="row g-2">
                        ...
                        <div class="col-6"><label class="form-label">Data i godz.</label>
                        ...
                        <div class="col-3"><label class="form-label">Gospodarze</label>
                            <input type="number" name="home_score" class="form-control" min="0" max="50" value="0">
                        </div>
                        <div class="col-3"><label class="form-label">Goście</label>
                            <input type="number" name="away_score" class="form-control" min="0" max="50" value="0">
                        </div>
