...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="mb-0"><i class="bi bi-people-fill text-primary me-2"></i>Drużyny — Hokej na trawie</h4>
    ...
    <div class="card shadow-sm mb-3">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                ...
                <form method="POST" action="<?= url('fieldhockey/teams/' . (int)$t['id'] . '/delete') ?>" onsubmit="return confirm('Usunąć?')">
                    <?= csrf_field() ?>
            ...
            <table class="table table-sm mb-0">
                ...
                <?php else: foreach ($roster as $p): ?>
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="<?= url('fieldhockey/players/' . (int)$p['id'] . '/delete') ?>" onsubmit="return confirm('Usunąć?')">
                                <?= csrf_field() ?>
    ...
    <div class="modal fade" id="addP<?= (int)$t['id'] ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="<?= url('fieldhockey/teams/' . (int)$t['id'] . '/player') ?>">
                    <?= csrf_field() ?>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-check mt-3"><input type="checkbox" name="is_captain" id="fhcap<?= (int)$t['id'] ?>" class="form-check-input"><label for="fhcap<?= (int)$t['id'] ?>" class="form-check-label">Kapitan</label></div>
                    </div>
...
<div class="modal fade" id="teamModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="<?= url('fieldhockey/teams/store') ?>">
                <?= csrf_field() ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3"><label class="form-label">Kategoria</label>
