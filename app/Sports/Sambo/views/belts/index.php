    ...
    <table class="table table-hover mb-0">
        ...
        <?php else: ?>
            <?php foreach ($belts as $b):
                ...
                $textColor = in_array($bi['color'], ['#000000', '#8B4513', '#28a745', '#007bff'], true) ? '#fff' : '#333';
            ?>
                <tr>
                    ...
                    <td>
                        <form method="POST" action="<?= url('sambo/belts/'.(int)$b['id'].'/delete') ?>"
...
<div class="modal fade" id="beltModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="<?= url('sambo/belts/store') ?>">
                <?= csrf_field() ?>
                <div class="modal-header">
                    <h5 class="modal-title"><i class="bi bi-shield-shaded me-1"></i> Nadaj pas</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success"><i class="bi bi-shield-shaded me-1"></i> Nadaj pas</button>
                </div>
            </form>
        </div>
    </div>
