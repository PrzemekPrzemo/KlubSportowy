-- Bridge mind-games base migration
-- Wspolne tabele dla sportow umyslowych: ratingi, partie.
SET foreign_key_checks = 0;

-- Rating IBPF/klubowy dla zawodnika
CREATE TABLE IF NOT EXISTS `bridge_ratings` (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    club_id INT UNSIGNED NOT NULL,
    member_id INT UNSIGNED NOT NULL,
    rating INT UNSIGNED NOT NULL DEFAULT 1200,
    rating_type VARCHAR(40) NOT NULL DEFAULT 'club' COMMENT 'club/national/ibpf',
    games_played INT UNSIGNED NOT NULL DEFAULT 0,
    title VARCHAR(20) NULL COMMENT 'klasa zawodnicza',
...
CREATE TABLE IF NOT EXISTS `bridge_games` (
    ...
    result_detail VARCHAR(40) NULL COMMENT 'kontrakty dla bridge',
    moves_count SMALLINT UNSIGNED NULL,
    duration_seconds INT UNSIGNED NULL,
    pgn TEXT NULL COMMENT 'NULL dla bridge',
