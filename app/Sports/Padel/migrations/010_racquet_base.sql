-- Padel racquet-sports base migration
...
CREATE TABLE IF NOT EXISTS `padel_courts` (
    ...
    KEY `idx_padel_courts_club` (`club_id`),
...
CREATE TABLE IF NOT EXISTS `padel_matches` (
    ...
    `notes`          VARCHAR(255) NULL,
    KEY `idx_padel_m_club_date` (`club_id`, `played_at`),
    KEY `idx_padel_m_pa`        (`player_a_id`),
    KEY `idx_padel_m_pb`        (`player_b_id`),
    KEY `idx_padel_m_court`     (`court_id`),
    FOREIGN KEY (`club_id`)     REFERENCES `clubs`(`id`)             ON DELETE CASCADE,
    ...
    FOREIGN KEY (`court_id`)    REFERENCES `padel_courts`(`id`)  ON DELETE SET NULL,
