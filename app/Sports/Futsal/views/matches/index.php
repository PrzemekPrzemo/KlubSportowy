...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="mb-0"><i class="bi bi-flag text-success me-2"></i>Mecze — Futsal</h4>
            ...
            ?>
                <tr>
                    ...
                    <td class="d-flex gap-1">
                        <a href="<?= url('futsal/matches/' . (int)$m['id'] . '/stats') ?>" class="btn btn-sm btn-outline-primary" title="Statystyki">
                            <i class="bi bi-bar-chart"></i>
                        </a>
                        <form method="POST" action="<?= url('futsal/matches/' . (int)$m['id'] . '/delete') ?>" onsubmit="return confirm('Usunąć?')">
                            <?= csrf_field() ?>
...
<div class="modal fade" id="matchModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="POST" action="<?= url('futsal/matches/store') ?>">
                <?= csrf_field() ?>
                ...
                <div class="modal-body">
                    <div class="row g-2">
                        ...
                        <div class="col-6"><label class="form-label">Goście (nazwa)</label>
                            <input type="text" name="away_team_name" class="form-control" placeholder="np. AZS UMK Toruń">
                        </div>
