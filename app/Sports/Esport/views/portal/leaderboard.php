...
<div class="card shadow-sm">
    <div class="table-responsive">
        <table class="table table-hover mb-0">
            ...
            <tbody>
            <?php if (empty($top)): ?>
                <tr><td colspan="5" class="text-center text-muted py-4">Brak graczy w tej grze.</td></tr>
            <?php else: foreach ($top as $i => $p): ?>
                <tr>
                    <td class="text-center">
                        <?php if ($i === 0): ?><i class="bi bi-trophy-fill text-warning fs-5"></i>
                        <?php elseif ($i === 1): ?><i class="bi bi-award-fill" style="color:#c0c0c0;font-size:1.2rem;"></i>
                        <?php elseif ($i === 2): ?><i class="bi bi-award-fill" style="color:#cd7f32;font-size:1.2rem;"></i>
                        <?php else: ?><strong><?= $i + 1 ?></strong>
                        <?php endif; ?>
                    </td>
