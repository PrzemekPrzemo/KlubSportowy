...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="mb-0">Wyniki/Pokazy — Aikido</h4>
...
<div class="card">
    <table class="table table-hover mb-0">
        <thead class="table-light">
            <tr><th>Zawodnik</th><th>Zawody</th><th>Data</th><th>Kategoria</th><th>Kat. wiekowa</th><th>Miejsce</th><th></th></tr>
        </thead>
        <tbody>
        ...
        <?php else: ?>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <form method="POST" action="<?= url('aikido/results/'.(int)$r['id'].'/delete') ?>"
...
<div class="modal fade" id="resultModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="<?= url('aikido/results/store') ?>">
                <?= csrf_field() ?>
                <div class="modal-header">
                    <h5 class="modal-title"><i class="bi bi-trophy me-1"></i> Dodaj wynik / pokaz</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Nazwa zawodów / wydarzenia *</label>
                        <input type="text" name="competition_name" class="form-control" required placeholder="np. Mistrzostwa Polski Aikido">
                    </div>
