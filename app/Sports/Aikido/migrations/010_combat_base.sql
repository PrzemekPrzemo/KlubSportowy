...
CREATE TABLE IF NOT EXISTS `aikido_weight_classes` (
    ...
    KEY `idx_aikido_wc_club` (`club_id`),
...
CREATE TABLE IF NOT EXISTS `aikido_belts` (
    ...
    UNIQUE KEY `uniq_club_code` (`club_id`, `code`),
    KEY `idx_aikido_belts_club` (`club_id`),
    FOREIGN KEY (`club_id`) REFERENCES `clubs`(`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `aikido_member_grades` (
    `id`           INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    `club_id`      INT UNSIGNED NOT NULL,
    ...
    KEY `idx_aikido_grades_member` (`member_id`),
    KEY `idx_aikido_grades_club`   (`club_id`),
    KEY `idx_aikido_grades_belt`   (`belt_id`),
    FOREIGN KEY (`club_id`)   REFERENCES `clubs`(`id`)              ON DELETE CASCADE,
    FOREIGN KEY (`member_id`) REFERENCES `members`(`id`)            ON DELETE CASCADE,
    FOREIGN KEY (`belt_id`)   REFERENCES `aikido_belts`(`id`)    ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
