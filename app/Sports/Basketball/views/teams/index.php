...
<div class="mb-3 text-end">
    <a href="<?= url('basketball/teams/create') ?>" class="btn btn-success"><i class="bi bi-plus"></i> Nowa drużyna</a>
</div>
<div class="card">
    <table class="table table-hover mb-0">
        ...
        <?php else: foreach ($teams as $t): ?>
            <tr>
                ...
                <td class="text-end">
                    <a href="<?= url('basketball/teams/' . (int)$t['id'] . '/edit') ?>" class="btn btn-sm btn-outline-secondary"><i class="bi bi-pencil"></i></a>
                </td>
            </tr>
