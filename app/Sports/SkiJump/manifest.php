...
return [
    ...
    'federation' => 'PZN',
    'status'     => 'full',
    'module'     => \App\Sports\SkiJump\SkiJumpModule::class,
    'archetype'  => \App\Sports\SkiJump\SkiJumpArchetype::class,
    'features'   => ['results', 'jumps', 'hill_k', 'fis_points', 'timing_results', 'verified_results', 'demo-ready'],
    'routes' => [
    ...
    'nav' => [
        ...
        ['label' => 'Wyniki (zunifikowane)', 'icon' => 'bi-stopwatch',             'url' => 'club/sport/skijump/results'],
    ],
