...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="mb-0">Wyniki zawodów — Judo</h4>
        ...
        <?php else: ?>
            ...
            ?>
                <tr>
                    ...
                    <td><span class="badge bg-secondary"><?= View::e($r['category']) ?></span></td>
                    <td><?= $medal ?> <?= $r['placement'] ? View::e($r['placement']).'.' : '—' ?></td>
                    <td>
                        <form method="POST" action="<?= url('judo/results/'.(int)$r['id'].'/delete') ?>"
...
<div class="modal fade" id="resultModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="<?= url('judo/results/store') ?>">
                <?= csrf_field() ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="competition_name" class="form-control" required placeholder="np. Mistrzostwa Polski Juniorów">
                    </div>
                    ...
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="category" class="form-select">
                                ...
                                <option value="para_judo">Para-judo</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3">
