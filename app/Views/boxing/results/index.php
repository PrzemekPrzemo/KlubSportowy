...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="mb-0">Wyniki zawodów — Boks</h4>
        ...
        <?php else: ?>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <form method="POST" action="<?= url('boxing/results/'.(int)$r['id'].'/delete') ?>"
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="age_category" class="form-control" placeholder="np. U17, Elite">
                        </div>
                    </div>
                    <div class="row g-2 mb-3">
                        <div class="col-md-6">
