...
<head>
    ...
    <style>
        body { background: linear-gradient(135deg, #198754 0%, #0d6efd 100%); min-height:100vh; display:flex; align-items:center; justify-content:center; font-family: system-ui, sans-serif; }
        ...
        .portal-brand h1 { font-size:1.6rem; color:#198754; margin:0; }
    </style>
</head>
<body>
<div class="portal-card">
    <div class="portal-brand">
        ...
        <small><?= View::e($appName ?? 'KlubSportowy') ?></small>
    </div>
