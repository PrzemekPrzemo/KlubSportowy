...
<head>
    ...
    <style>
        body { background: linear-gradient(135deg, #E52C38 0%, #0d6efd 100%); min-height:100vh; display:flex; align-items:center; justify-content:center; font-family: 'Poppins', system-ui, sans-serif; }
        ...
        .portal-brand h1 { font-size:1.6rem; color:#E52C38; margin:0; }
    </style>
</head>
<body>
