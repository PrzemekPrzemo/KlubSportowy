...
<nav class="sidebar" id="sidebar">
    ...
    $allItems = [
        ...
        'trainer_schedule' => ['url' => 'club/trainer-schedule',    'icon' => 'bi-calendar2-week',         'label' => __('nav.trainer_schedule'), 'mod' => 'trainings'],
        ...
        'achievements'   => ['url' => 'club/achievements',          'icon' => 'bi-trophy-fill',            'label' => __('nav.achievements'),    'mod' => null],
        ...
        'ksef_invoices'  => ['url' => 'club/invoices',              'icon' => 'bi-receipt-cutoff',         'label' => __('nav.ksef_invoices'),   'mod' => 'fees'],
        ...
        'reports_builder'=> ['url' => 'club/reports-builder',       'icon' => 'bi-tools',                  'label' => __('nav.reports_builder'), 'mod' => 'reports'],
        'scheduled_reports' => ['url' => 'club/scheduled-reports',  'icon' => 'bi-envelope-paper',         'label' => __('nav.scheduled_reports'), 'mod' => 'reports'],
