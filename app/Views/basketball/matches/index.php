...
<div class="card p-3 mb-3">
    <form method="GET" class="row g-2">
        ...
        <div class="col-md-3"><a href="<?= url('basketball/matches/create') ?>" class="btn btn-success w-100"><i class="bi bi-plus"></i> Nowy mecz</a></div>
    </form>
</div>
<div class="card">
    <table class="table table-hover mb-0">
        ...
        <?php else: foreach ($pagination['data'] as $m): ?>
            <tr>
                ...
                <td>
                    <a href="<?= url('basketball/matches/' . (int)$m['id']) ?>">
                ...
                <td class="text-end">
                    <a href="<?= url('basketball/matches/' . (int)$m['id'] . '/edit') ?>" class="btn btn-sm btn-outline-secondary"><i class="bi bi-pencil"></i></a>
                </td>
            </tr>
